...
map("n", "<Leader>e", "<Cmd>Lspsaga show_cursor_diagnostics<CR>", { desc = "Diagnostic open float" })
map("n", "<Leader>l", "<Cmd>Lspsaga show_buf_diagnostics<CR>", { desc = "Diagnostic set locllist" })

...
export FZF_DEFAULT_COMMAND="fd --type f --exclude .git --exclude .idea --exclude .vscode --exclude .sass-cache --exclude node_modules --exclude build --exclude dist --exclude vendor"
